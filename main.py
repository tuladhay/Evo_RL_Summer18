...
def parse_arguments():
    global parser
    parser = argparse.ArgumentParser(description='PyTorch ERL implementation')
    ...
    parser.add_argument('--num_steps', type=int, default=1500, metavar='N',
...
if __name__ == "__main__":
    ...
    pickling_on = open("ERL_springmass.p", "wb")
    ...
    torch.save(evo.best_policy.actor.state_dict(), 'params_ERL_springmass.pt')
